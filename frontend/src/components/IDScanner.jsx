...
export default function IDScanner() {
  ...
  const idScanUri = useMediationStore((s) => s.id_scan_uri);
      ...
      <div className="archival-card" style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        {!isAwaitingReview ? (
          ...
          <div className="banner banner-info" style={{ marginBottom: 'var(--space-md)' }}>
            <strong>ID Submitted for Executor Review</strong>
            <p className="text-sm" style={{ margin: '4px 0 0' }}>
              ID scan submitted for Executor review. You can edit your legal profile while the Executor reviews your document.
            </p>
          </div>
        )}
